...
func (r *productImageRepository) Create(ctx context.Context, image *ProductImage) error {
	query := `
...
func (r *productImageRepository) FindByProductID(ctx context.Context, productID int64) ([]ProductImage, error) {
	query := `
