        ...
        "/api/products": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Talla (S,M,L,XL,XXL)",
                        "name": "size",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Búsqueda en título/desc",
                        "name": "q",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Límite (\u003c=100)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.TicketReceiptResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
    ...
    "definitions": {
        "dto.CreateProductRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Remera de algodón 100% color negro, cuello redondo"
                },
                "size": {
        ...
        "dto.TicketReceiptResponse": {
            ...
            "properties": {
                ...
                "lines": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.TicketLineResponse"
                    }
                },
                "notes": {
                    "type": "string"
